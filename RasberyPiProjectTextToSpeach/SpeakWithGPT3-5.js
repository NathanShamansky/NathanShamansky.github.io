...
function startRecognition() {
    ...
    stopButton.classList.remove("IsSpeakingOverButtonClass");
    startButton.classList.remove("IsSpeakingOverButtonClass");
}
...
async function getAssistantResponse(userMessage) {
    stopButton.classList.add("IsSpeakingOverButtonClass");
    startButton.classList.add("IsSpeakingOverButtonClass");
...
function displayMessage(message) {
    ...
    listItem.classList.add(message.role === "user" ? "UserMessageJustSpawned" : "AIMessageJustSpawned")
    setTimeout(function() {
        myObject.classList.add("animate");
    }, 500);
